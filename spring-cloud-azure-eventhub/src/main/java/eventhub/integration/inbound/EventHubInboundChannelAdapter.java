...
import eventhub.core.EventHubOperations;
import eventhub.integration.AckMode;
...
public class EventHubInboundChannelAdapter extends MessageProducerSupport {
	...
	private final EventHubOperations pubSubTemplate;
	...
	public EventHubInboundChannelAdapter(EventHubOperations pubSubTemplate, String subscriptionName) {
	...
	private void receiveMessage(PubsubMessage pubsubMessage, AckReplyConsumer consumer) {
		...
		if (this.ackMode == AckMode.MANUAL) {
			...
			messageHeaders.put(EventHubHeaders.ACKNOWLEDGEMENT, consumer);
		}
